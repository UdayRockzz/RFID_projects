...
void iot_rfid()
{
        ...
        if(( (mfrc522.uid.uidByte[0] == 108) && (mfrc522.uid.uidByte[1] == 159) && (mfrc522.uid.uidByte[2] == 37) && (mfrc522.uid.uidByte[3] == 217))&& (eflag == 1) )
        {
         Serial.println("ROCK"); 
         Blynk.virtualWrite(V2, "ROCK" );
         digitalWrite(elock, HIGH); 
         delay(5000); 
         digitalWrite(elock, LOW); 
        }
